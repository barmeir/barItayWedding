...
export const stages = [
  ...
  },
  {
    ...
    title: 'היעד הסודי',
    riddle:
      'עיר אגדית אבודה, התושב שלנו שואל את שמה. לחשו את שמה והשערים ייפתחו.',
    answers: ['אטלנטיס', 'atlantis', 'atlantis garden'],
    hints: [
      'עיר מיתולוגית ששקעה בים.',
      'אפלטון כתב עליה קודם כולם.',
      'התושב נקרא “____ Garden”.',
    ],
  ...
  },
  {
    ...
    title: 'סיפור ההיכרות',
    riddle:
      'שני מהנדסים, תעשייה אחת. היכן מתחילה מערכת האהבה של בר ואיתי, וגם הקריירה?',
